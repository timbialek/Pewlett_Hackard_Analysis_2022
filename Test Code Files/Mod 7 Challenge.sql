...
-- Create retirement titles by deptartment table
SELECT DISTINCT ON (u.emp_no) de.dept_name
...
GROUP BY u.emp_no, de.dept_name

SELECT COUNT (u.emp_no) FROM retirement_department

-- Count retirement titles by deptartment table
